---
title: Scanning
description: Inspect vs Scan and module boundary detection
author: zoobzio
...
- [Custom Tags](2.tags.md) — registering and extracting struct tags
- [Testing](3.testing.md) — test isolation and patterns
- [API Reference](../4.reference/1.api.md#scan) — complete Scan documentation
