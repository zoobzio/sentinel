...
[rocco](https://github.com/zoobz-io/rocco) is a type-safe HTTP framework. Handlers are generic—`Handler[In, Out]`—so request and response types are known at compile time. From these types, rocco automatically generates OpenAPI 3.1.0 specifications.
...
- [rocco repository](https://github.com/zoobz-io/rocco)
- [openapi repository](https://github.com/zoobz-io/openapi) — OpenAPI type definitions
